 ...
 * @author Ernesto
 */
public class frameTeoria extends javax.swing.JFrame {

    /**
     * Creates new form frameTeoria
     */
    public frameTeoria() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frameTeoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
