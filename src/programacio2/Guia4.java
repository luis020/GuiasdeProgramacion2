 ...
 * @author Ernesto
 */
public class Guia4 extends frameGuia3 {
...
//int num2 = getBat();
    ...
    void refDeMarca() {
        ...
        if (marca.equals("SAMSUNG") || marca.equals("IPhone") || marca.equals("Nokia") || marca.equals("Alcatel") || marca.equals("HUAWEI") || marca.equals("SONY")) {
            puntuacion = 4;
        }

        if (marca.equals("SAMSUNG") || marca.equals("Alcatel") || marca.equals("SONY")) {
            puntuacion = 3;
        }
